      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            ...
            background: 'rgba(92, 143, 166, 0.15)', border: '1px solid rgba(92, 143, 166, 0.3)',
            display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1rem',
          }}>
            <ShieldCheck size={26} color="var(--accent)" />
          </div>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.6rem', color: 'var(--cream)', letterSpacing: '0.05em' }}>
            ADMIN PORTAL
          </h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.83rem', marginTop: '0.3rem' }}>ATLAS Dashboard</p>
        </div>
          ...
          {[
            ...
            <div key={f.name}>
              ...
              <div style={{ position: 'relative' }}>
                <span style={{ position: 'absolute', left: '0.75rem', top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted)', zIndex: 1 }}>{f.icon}</span>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem' }}>
          <Link to="/" className="label" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}>← Back to site</Link>
        </p>
      </motion.div>
    </div>
  );
